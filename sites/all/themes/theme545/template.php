<?php
// $Id: template.php,v 1.1 2011/02/14 16:19:56 Leo Exp $
/**
 * @file
 * Contains theme override functions and preprocess functions for the theme545 theme.
 */
/**
 * Changes the default meta content-type tag to the shorter HTML5 version
 */
function theme545_html_head_alter(&$head_elements) {
 ...
 */
function theme545_preprocess_search_block_form(&$vars) {
...
function theme545_preprocess_html(&$vars) {
  ...
  if ($vars['is_admin']) {
	...
	if (!$vars['is_front']) {
		...
		$vars['classes_array'][] = theme545_id_safe('page-'. $path);
		$vars['classes_array'][] = theme545_id_safe('section-'. $section);
...
function theme545_preprocess_page(&$vars) {
 ...
 */
function theme545_preprocess_node(&$vars) {
  // Striping class
...
function theme545_preprocess_block(&$vars, $hook) {
 ...
 */
function theme545_breadcrumb($vars) {
 ...
 */	
function theme545_id_safe($string) {
